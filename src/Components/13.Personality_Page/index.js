...
const history = useHistory();
  ...
  return (
    isAuthenticated && (<div>
    <NavTop />
    <div style={{ paddingBottom: '100px', paddingRight: '2em', paddingLeft: '2em' }}>
    <H1 text='Myers-Briggs'/>
    <Typography variant='subtitle2'>Check what different Myers-Briggs are like to work with</Typography>
